...
// Your code here...
const adding = string2[2] + string2[11] + string2[11] + string2[10];
...
// Your code here...
const findingK = fruit.indexOf('k');
console.log(findingK);
...
// Your code here ...
const pizza = 'oxygen';
if (funnyHeadline1.includes(pizza)) {
...
// Your code here ...
if (funnyHeadline2.includes(pizza)) {
console.log("The string includes the word 'oxygen'");
} else {
    console.log("The string does not include the word 'oxygen'");
}
...
// Your code here ...
const lastChar = string4 [length - 1];
